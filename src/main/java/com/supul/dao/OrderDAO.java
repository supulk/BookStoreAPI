...
public class OrderDAO {
    ...
    static{
        ...
        Order order1 = new Order(1, 3000, order1Items); 
        order1.setId(1);
        ...
        Order order2 = new Order(2, 5000, order2Items);
        order2.setId(1);
        ...
        Order order3 = new Order(3, 4500, order3Items);
        order3.setId(1);
        ...
        Order order4 = new Order(4, 6700, order4Items);
        order4.setId(1);
        ...
        Order order5 = new Order(5, 7000, order5Items);
        order5.setId(1);
        ...
        order6Items.put(7, 1); // Educated, 1 copy
        Order order6 = new Order(6, 1000, order6Items);
        order6.setId(1);
        ...
        Order order7 = new Order(7, 2500, order7Items);
        order7.setId(1);
        ...
        Order order8 = new Order(8, 850, order8Items);
        order8.setId(1);
        ...
        Order order9 = new Order(9, 2300, order9Items);
        order9.setId(1);
        ...
        Order order10 = new Order(10, 1500, order10Items);
        order10.setId(1);
    ...
    public void addOrder(int customerId, int total, Map<Integer, Integer> orderItems){
        ...
        if(orders.containsKey(customerId)){
            ...
            Order order = new Order(customerId, total, orderItems);
            order.setId(nextId);
